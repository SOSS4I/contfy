...
const navigation = [
  { name: 'Painel de Controle', href: '/cliente', icon: FiHome },
  { name: 'Documentos', href: '/cliente/documentos', icon: FiUpload },
  { name: 'Impostos', href: '/cliente/impostos', icon: FiDollarSign },
  { name: 'Declarações', href: '/cliente/declaracoes', icon: FiFile },
  { name: 'Assistente IA', href: '/cliente/chat', icon: FiMessageSquare },
]

const secondaryNav = [
  { name: 'Meu Perfil', href: '/cliente/perfil', icon: FiUser },
  { name: 'Configurações', href: '/cliente/configuracoes', icon: FiSettings },
]
...
export default function ClientSidebar({ mobileOpen = false, onMobileClose }: ClientSidebarProps) {
        ...
        <div className="p-6 border-b border-slate-700/50">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 font-medium">Portal Empresarial</p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-700/50 rounded-xl p-4 border border-slate-700/50 shadow-lg">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-slate-400 truncate">{user?.email || 'email@empresa.com'}</p>
              </div>
            </div>
          </div>
        </div>
